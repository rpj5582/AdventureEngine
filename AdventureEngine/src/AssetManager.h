...
namespace AdventureEngine
{
	...
	public:
		...
		static Texture* loadTexture(std::string file, glm::uvec2 atlasSize);
	...
	private:
		...
		static Model* bufferModel(std::string file, const std::vector<GLfloat> positionData, const std::vector<GLfloat> uvData, const std::vector<GLfloat> normalData, const std::vector<GLuint> indices);
